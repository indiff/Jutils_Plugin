...
public class Editor {
	...
	public  String getEditplusPath() {
		...
		if ( EDITPLUS_PATH == null ) {
			EDITPLUS_PATH = guessNotepadPlusPlus();
		}
	 ...
	 * @return
	 */
	private static String guessEditplus() {
		String[] drivers = {
				"C:",
				"D:",
				"E:",
		...
		String[] programFiles = {
				...
				"softwares",
				"软件",
				"SVN" + File.separator + "software" + File.separator + "EditPlus" ,
		};
	 ...
	 * @return
	 */
	private static String guessNotepadPlusPlus() {
		String[] drivers = {
				"C:",
				"D:",
				"E:",
		...
		String[] programFiles = {
				...
				"softwares",
				"软件",
				"SVN" + File.separator + "software" + File.separator + "Notepad" ,
		};
